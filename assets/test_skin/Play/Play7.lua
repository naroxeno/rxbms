...
local function main()
	...
	if is1p() then
		...
		geometry.note_relative_x[8] = 0
		geometry.lane_center_relative_x[8] = geometry.note_s_w / 2
	else
		...
		geometry.lane_center_relative_x[8] = geometry.lane_center_relative_x[8] + geometry.note_s_w / 2 - geometry.note_b_w / 2
	end
	...
	skin.note = {
		...
		group = {
			{id = "section-line", offset = 3, op = {81}, dst = {
				{x = geometry.lane_x, y = geometry.lane_y, w = geometry.lane_w, h = 3, r = 127, g = 127, b = 127}
			}}
		},
		time = {
			{id = "section-line", offset = 3, op = {81}, dst = {
				{x = geometry.lane_x, y = geometry.lane_y, w = geometry.lane_w, h = 3, r = 100, g = 100, b = 255}
			}}
		},
		bpm = {
			{id = "section-line", offset = 3, op = {81}, dst = {
				{x = geometry.lane_x, y = geometry.lane_y, w = geometry.lane_w, h = 3, r = 100, g = 255, b = 100}
			}}
		},
		stop = {
			{id = "section-line", offset = 3, op = {81}, dst = {
				{x = geometry.lane_x, y = geometry.lane_y, w = geometry.lane_w, h = 3, r = 255, g = 100, b = 100}
			}}
		}
	}
	for i = 1, 8 do
		if i == 8 then
			table.insert(skin.note.dst, {x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_s_w, h = geometry.lane_h})
		elseif i % 2 == 1 then
			table.insert(skin.note.dst, {x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_w_w, h = geometry.lane_h})
		else
			table.insert(skin.note.dst, {x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_b_w, h = geometry.lane_h})
		end
	end
...
-- Key beam
	...
	for i = 1, 7, 2 do
		table.insert(skin.destination, {id = "keybeam-w", offset = 3, timer = 100 + i, op = {81}, blend = 1, dst = {
			{x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_w_w, h = geometry.keybeam_h}
		}})
		table.insert(skin.destination, {id = "keybeam-w", offset = 3, timer = 120 + i, loop = -1, op = {81}, blend = 1, dst = {
			{time = 0, x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_w_w, h = geometry.keybeam_h},
			{time = 80, x = geometry.lane_x + geometry.lane_center_relative_x[i], w = 0, a = 0}
		}})
	end

	for i = 2, 6, 2 do
		table.insert(skin.destination, {id = "keybeam-b", offset = 3, timer = 100 + i, op = {81}, blend = 1, dst = {
			{x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_b_w, h = geometry.keybeam_h}
		}})
		table.insert(skin.destination, {id = "keybeam-b", offset = 3, timer = 120 + i, loop = -1, op = {81}, blend = 1, dst = {
			{time = 0, x = geometry.lane_x + geometry.note_relative_x[i], y = geometry.lane_y, w = geometry.note_b_w, h = geometry.keybeam_h},
			{time = 80, x = geometry.lane_x + geometry.lane_center_relative_x[i], w = 0, a = 0}
		}})
	end

	table.insert(skin.destination,	{id = "keybeam-s", offset = 3, timer = 100, op = {81,940}, blend = 1, dst = {
		{x = geometry.lane_x + geometry.note_relative_x[8], y = geometry.lane_y, w = geometry.note_s_w, h = geometry.keybeam_h}
	}})

	table.insert(skin.destination, {id = "keybeam-s", offset = 3, timer = 100, op = {81,941}, loop = -1, blend = 1, dst = {
		{time = 0, x = geometry.lane_x + geometry.note_relative_x[8], y = geometry.lane_y, w = geometry.note_s_w, h = geometry.keybeam_h},
		{time = 80},
		{time = 160, x = geometry.lane_x + geometry.lane_center_relative_x[8], w = 0, a = 0}
	}})

	table.insert(skin.destination, {id = "keybeam-s", offset = 3, timer = 120, op = {81,940}, loop = -1, blend = 1, dst = {
		{time = 0, x = geometry.lane_x + geometry.note_relative_x[8], y = geometry.lane_y, w = geometry.note_s_w, h = geometry.keybeam_h},
		{time = 80, x = geometry.lane_x + geometry.lane_center_relative_x[8], w = 0, a = 0}
	}})
...
-- Bomb
	...
	for i = 1, 7, 1 do
		table.insert(skin.destination, {id = "bomb-"..i, offset = 3, loop = -1, filter = 1, timer = 50 + i, blend = 2, dst = {
			{time = 0, x = geometry.lane_x + geometry.lane_center_relative_x[i] - 144, y = geometry.lane_y - 136, w = 288, h = 288},
			{time = 160}
		}})
	end

	table.insert(skin.destination, {id = "bomb-s", offset = 3, loop = -1, filter = 1, timer = 50, blend = 2, dst = {
		{time = 0, x = geometry.lane_x + geometry.lane_center_relative_x[8] - 144, y = geometry.lane_y - 136, w = 288, h = 288},
		{time = 160}
	}})
